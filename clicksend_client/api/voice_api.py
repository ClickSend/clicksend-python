...
class VoiceApi(object):
    ...
    def voice_receipts_post(self, url, **kwargs):  # noqa: E501
        """Add a delivery receipt  # noqa: E501

        Add a delivery receipt  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_receipts_post(url, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.voice_receipts_post_with_http_info(url, **kwargs)  # noqa: E501
        else:
            (data) = self.voice_receipts_post_with_http_info(url, **kwargs)  # noqa: E501
            return data

    def voice_receipts_post_with_http_info(self, url, **kwargs):  # noqa: E501
        """Add a delivery receipt  # noqa: E501

        Add a delivery receipt  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_receipts_post_with_http_info(url, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method voice_receipts_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def voice_receipts_read_put(self, **kwargs):  # noqa: E501
        """Mark delivery receipts as read  # noqa: E501

        Mark delivery receipts as read  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_receipts_read_put(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.voice_receipts_read_put_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.voice_receipts_read_put_with_http_info(**kwargs)  # noqa: E501
            return data

    def voice_receipts_read_put_with_http_info(self, **kwargs):  # noqa: E501
        """Mark delivery receipts as read  # noqa: E501

        Mark delivery receipts as read  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_receipts_read_put_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method voice_receipts_read_put" % key
                )
            params[key] = val
        del params['kwargs']
