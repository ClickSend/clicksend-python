...
class EmailToSmsApi(object):
    ...
    def sms_email_sms_get(self, **kwargs):  # noqa: E501
    ...
    def sms_email_sms_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get list of email to sms allowed addresses  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method sms_email_sms_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def sms_email_sms_post(self, email_sms_address, **kwargs):  # noqa: E501
    ...
    def sms_email_sms_post_with_http_info(self, email_sms_address, **kwargs):  # noqa: E501
        """Create email to sms allowed address  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        body_params = None
        if 'email_sms_address' in params:
            body_params = params['email_sms_address']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def sms_email_sms_stripped_string_delete(self, rule_id, **kwargs):  # noqa: E501
    ...
    def sms_email_sms_stripped_string_delete_with_http_info(self, rule_id, **kwargs):  # noqa: E501
        """Delete email to sms stripped string rule  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_stripped_string_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/sms/email-sms-stripped-strings/{rule_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def sms_email_sms_stripped_string_get(self, rule_id, **kwargs):  # noqa: E501
    ...
    def sms_email_sms_stripped_string_get_with_http_info(self, rule_id, **kwargs):  # noqa: E501
        """Get email to sms stripped string rule  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_stripped_string_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'rule_id' is set
        ...
        return self.api_client.call_api(
            '/sms/email-sms-stripped-strings/{rule_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def sms_email_sms_stripped_string_post(self, strip_string, **kwargs):  # noqa: E501
        """Create email to sms stripped string rule  # noqa: E501

        Create email to sms stripped string rules  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sms_email_sms_stripped_string_post(strip_string, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str strip_string: String to be stripped. (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sms_email_sms_stripped_string_post_with_http_info(strip_string, **kwargs)  # noqa: E501
        else:
            (data) = self.sms_email_sms_stripped_string_post_with_http_info(strip_string, **kwargs)  # noqa: E501
            return data

    def sms_email_sms_stripped_string_post_with_http_info(self, strip_string, **kwargs):  # noqa: E501
        """Create email to sms stripped string rule  # noqa: E501

        Create email to sms stripped string rules  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sms_email_sms_stripped_string_post_with_http_info(strip_string, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['strip_string']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_stripped_string_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'strip_string' is set
        if ('strip_string' not in params or
                params['strip_string'] is None):
            raise ValueError("Missing the required parameter `strip_string` when calling `sms_email_sms_stripped_string_post`")  # noqa: E501
        ...
        form_params = []
        local_var_files = {}
        if 'strip_string' in params:
            form_params.append(('strip-string', params['strip_string']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/sms/email-sms-stripped-strings', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def sms_email_sms_stripped_string_put(self, strip_string, rule_id, **kwargs):  # noqa: E501
        """Update email to sms stripped string rule  # noqa: E501

        Update email to sms stripped string rule  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sms_email_sms_stripped_string_put(strip_string, rule_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sms_email_sms_stripped_string_put_with_http_info(strip_string, rule_id, **kwargs)  # noqa: E501
        else:
            (data) = self.sms_email_sms_stripped_string_put_with_http_info(strip_string, rule_id, **kwargs)  # noqa: E501
            return data

    def sms_email_sms_stripped_string_put_with_http_info(self, strip_string, rule_id, **kwargs):  # noqa: E501
        """Update email to sms stripped string rule  # noqa: E501

        Update email to sms stripped string rule  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sms_email_sms_stripped_string_put_with_http_info(strip_string, rule_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['strip_string', 'rule_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_stripped_string_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'strip_string' is set
        if ('strip_string' not in params or
                params['strip_string'] is None):
            raise ValueError("Missing the required parameter `strip_string` when calling `sms_email_sms_stripped_string_put`")  # noqa: E501
        # verify the required parameter 'rule_id' is set
        if ('rule_id' not in params or
                params['rule_id'] is None):
        ...
        return self.api_client.call_api(
            '/sms/email-sms-stripped-strings/{rule_id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def sms_email_sms_stripped_strings_get(self, **kwargs):  # noqa: E501
    ...
    def sms_email_sms_stripped_strings_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get list of email to sms stripped string rules  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method sms_email_sms_stripped_strings_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/sms/email-sms-stripped-strings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
