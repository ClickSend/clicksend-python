...
class MMSApi(object):
    ...
    def mms_history_export_get(self, filename, **kwargs):  # noqa: E501
        """Export all mms history  # noqa: E501

        Export all mms history  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mms_history_export_get(filename, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.mms_history_export_get_with_http_info(filename, **kwargs)  # noqa: E501
        else:
            (data) = self.mms_history_export_get_with_http_info(filename, **kwargs)  # noqa: E501
            return data

    def mms_history_export_get_with_http_info(self, filename, **kwargs):  # noqa: E501
        """Export all mms history  # noqa: E501

        Export all mms history  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mms_history_export_get_with_http_info(filename, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method mms_history_export_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('filename' not in params or
            ...
            raise ValueError("Missing the required parameter `filename` when calling `mms_history_export_get`")  # noqa: E501
    ...
    def mms_history_get(self, **kwargs):  # noqa: E501
        """Get all mms history  # noqa: E501

        Get all mms history  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mms_history_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mms_history_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.mms_history_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def mms_history_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get all mms history  # noqa: E501

        Get all mms history  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mms_history_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method mms_history_get" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `mms_history_get`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `mms_history_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
