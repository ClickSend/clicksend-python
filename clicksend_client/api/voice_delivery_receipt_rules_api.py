...
class VoiceDeliveryReceiptRulesApi(object):
    ...
    def voice_delivery_receipt_automations_get(self, q, **kwargs):  # noqa: E501
        """Get all voice delivery receipt automations  # noqa: E501

        Get all voice delivery receipt automations  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_delivery_receipt_automations_get(q, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.voice_delivery_receipt_automations_get_with_http_info(q, **kwargs)  # noqa: E501
        else:
            (data) = self.voice_delivery_receipt_automations_get_with_http_info(q, **kwargs)  # noqa: E501
            return data

    def voice_delivery_receipt_automations_get_with_http_info(self, q, **kwargs):  # noqa: E501
        """Get all voice delivery receipt automations  # noqa: E501

        Get all voice delivery receipt automations  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.voice_delivery_receipt_automations_get_with_http_info(q, async_req=True)
        >>> result = thread.get()
        ...
        if ('q' not in params or
                params['q'] is None):
            raise ValueError("Missing the required parameter `q` when calling `voice_delivery_receipt_automations_get`")  # noqa: E501
