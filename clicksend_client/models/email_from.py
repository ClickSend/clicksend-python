...
class EmailFrom(object):
    ...
    def __init__(self, email_address_id=None, name=None, _configuration=None):  # noqa: E501
    ...
    def email_address_id(self, email_address_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and email_address_id is None:
