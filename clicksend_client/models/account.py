...
class Account(object):
    ...
    def __init__(self, username=None, password=None, user_phone=None, user_email=None, user_first_name=None, user_last_name=None, account_name=None, country=None, _configuration=None):  # noqa: E501
