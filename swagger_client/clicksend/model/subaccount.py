...
class Subaccount(object):
    ...
    def __init__(self, api_username=None, password=None, email=None, phone_number=None, first_name=None, last_name=None, access_users=1, access_billing=1, access_reporting=1, access_contacts=0, access_settings=1):  # noqa: E501
