...
class ResellerAccount(object):
    ...
    def __init__(self, username=None, password=None, user_email=None, user_phone=None, user_first_name=None, user_last_name=None, account_name=None, country=None):  # noqa: E501
