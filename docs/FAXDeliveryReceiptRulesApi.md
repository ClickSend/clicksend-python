...
> str fax_delivery_receipt_automations_get(q, page=page, limit=limit)
...
try:
    # Get all fax delivery receipt automations
    api_response = api_instance.fax_delivery_receipt_automations_get(q, page=page, limit=limit)
    pprint(api_response)
except ApiException as e:
