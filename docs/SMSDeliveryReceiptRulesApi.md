# swagger_client.SMSDeliveryReceiptRulesApi
...
api_instance = swagger_client.SMSDeliveryReceiptRulesApi(swagger_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = swagger_client.SMSDeliveryReceiptRulesApi(swagger_client.ApiClient(configuration))
delivery_receipt_rule = swagger_client.DeliveryReceiptRule() # DeliveryReceiptRule | sms delivery receipt rule model
