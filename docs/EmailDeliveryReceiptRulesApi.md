...
> str email_delivery_receipt_automations_get(q, page=page, limit=limit)
...
try:
    # Get all email delivery receipt automations
    api_response = api_instance.email_delivery_receipt_automations_get(q, page=page, limit=limit)
    pprint(api_response)
except ApiException as e:
