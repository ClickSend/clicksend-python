...
from ClickSend.Client.Api.transfer_credit_api import TransferCreditApi  # noqa: E501
...
class TestTransferCreditApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = ClickSend.Client.Api.transfer_credit_api.TransferCreditApi()  # noqa: E501
